...
**Agent profile:** [../AGENTS.md](../AGENTS.md) and `.cursor/rules/meridian.mdc`.
...
Seed JSON in this clone lives in `../data_mock/` (doc 06 also refers to `mock-data/` for the `@meridian/mock-data` package).
