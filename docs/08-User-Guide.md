...
Placeholder panels in this build: News, Screener, Portfolio, Copilot (input only), Description (`DES`). **Watchlist** (PBI-007), **Chart** (PBI-008), **Order ticket** (PBI-013), and **Blotter** (PBI-017) are live. `DES <symbol>` opens the Description placeholder until fundamentals ship.
