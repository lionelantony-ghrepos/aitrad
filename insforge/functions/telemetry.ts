...
// bundled from insforge/functions/telemetry-src.ts
...
// insforge/functions/telemetry-src.ts
...
async function handleTelemetryRequest(input) {
...
async function ingest(ports, req, userId, isService) {
  const requestId =
...
var telemetry_src_default = withFunctionLog("telemetry", handle);

module.exports = telemetry_src_default;
