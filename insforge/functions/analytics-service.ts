...
var analytics_service_src_default = withFunctionLog("analytics-service", async function (req) {
  if (req.method === "OPTIONS") {
  ...
  if (op === "rsi") {
    ...
    const admin2 = createAdminClient2({ baseUrl, apiKey: expected });
    try {
...
module.exports = analytics_service_src_default;
